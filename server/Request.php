...
/**
 * Represents an incoming request from the client.
 */
class Request {
	...
	/** @var string The client's callback URL where new posts should be sent. */
	public $callback = '';

	/** @var string The topic we're requesting a subscription to. Usually the feed URL. */
	public $topic = '';

	/** @var string The verification mode, either "async" or "sync", for asynchronous or synchronous verification, respectively. */
	public $verifymode = 'async';
